  ...
  <el-card>
    <el-form ref="searchForm" :inline="true" :model="searchFormModel" label-width="undefined" size="small"
      ...
      <el-form-item :label="$t('forms.gatewayIp')" prop="gatewayIp">
        <el-input v-model="searchFormModel.gatewayIp" :disabled="modal_loading"
      ...
      <el-form-item :label="$t('forms.responseStatus')" prop="responseStatus">
        <el-input v-model="searchFormModel.responseStatus" :disabled="modal_loading" :placeholder="$t('forms.pleaseEnter') + $t('forms.responseStatus')"
                  type="number"
                  @keyup.enter.native="handleSearch"/>
      </el-form-item>
  ...
  methods: {
    ...
    handleSearch() {
      let searchParam = {
        ...
        gatewayIp: this.searchFormModel.gatewayIp,
