...
###### v4.2.3 [版本更新日志](doc/version_history.md)
...
> 使用vue全家桶(Vue+Vue-router+Vuex+axios)、ElementUI样式库构建的前端项目。该项目是前后端分离架构中的“前端部分” 。后端工程[V4.2.3](https://github.com/zhangbin1010/acp-admin-cloud)
